...
NestedModules = @('DiskSmartInfo.functions.ps1', 'attributes/default.ps1')
...
FileList = 'DiskSmartInfo.psd1', 'DiskSmartInfo.psm1', 'DiskSmartInfo.functions.ps1', 'DiskSmartInfo.format.ps1xml', 'attributes/default.ps1'
