...
NestedModules = @('DiskSmartInfo.functions.ps1',
               'smartAttributes.ps1')
...
FileList = 'DiskSmartInfo.psd1', 'DiskSmartInfo.psm1', 'DiskSmartInfo.functions.ps1', 'smartAttributes.ps1', 'DiskSmartInfo.format.ps1xml'
