...
$PesterConfiguration.Run.Path = './tests/DiskSmartInfo.completers.tests.ps1',
                                ...
                                './tests/DiskSmartInfo.remoting.PSSession.mocked.tests.ps1',
                                './tests/DiskSmartInfo.remoting.SSHSession.mocked.tests.ps1',
